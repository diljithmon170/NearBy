...
<div class="login-box">
  <div class="login-logo" style="font-size:40px;">
    <a href=""><b><h1 style="color:black;">NearBy</h1></b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
   <b> <p style="font-size:20px;color:black" class="login-box-msg">Buyer Register&nbsp;&nbsp;&nbsp;<a href="../../index.html">Back</a></p></b>
...
<option value="Others">Others</option></select></div>
   ...
   name="contactnumber"  id="contactnumber" placeholder="contactnumber" class="form-control"  required=""/>
	  ...
	  <div class="form-group has-feedback">
        <input type="password" name="retype" class="form-control" placeholder="RetypePassword">
...
if(isset($_POST["submit"]))
{
	...
	$sql="insert into buyer_tbl(firstname,lastname,gender,contactnumber,emailid,address,password,retype)values('$firstname','$lastname','$gender','$contactnumber','$emailid','$address','$password','$retype')";
