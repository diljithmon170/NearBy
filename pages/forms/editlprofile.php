            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Buyer Profile</li>
                    </ol>
                </section>
...
if(isset($_POST["submit"]))
{
	...
	$retype=$_POST['retype'];
	 ...
	 $sql = "update buyer_tbl set firstname='$firstname',lastname='$lastname',gender='$gender',contactnumber='$contactnumber',emailid='$emailid',address='$address',password='$password',retype='$retype' where emailid='$session_id' ";
...
$sql = "SELECT * from  buyer_tbl where emailid='$session_id'";
