                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Total Seller Details</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">                                    
...
//                                            
            ...
            $result = $con->query($sql); $count = 1;
            if ($result->num_rows > 0) {

                while ($row = $result->fetch_assoc()) {

                    echo "<tr><td>" . $count . "<td>" . $row["firstname"] . "</td><td>" . $row["lastname"] . "</td><td>" . $row["gender"] . "</td><td>" . $row["address"] . "</td><td>" . $row["emailid"] . "</td>";
                   // echo'<td> <a class="btn "><i class="fa fa-pencil"  onClick="upd(' . $row["lid"] . ')"></i></a><a class="btn "><i class="fa fa-trash-o"  onClick="del(' . $row["lid"] . ')"></i></a></td>';
                   echo '</tr>';
$count++;
