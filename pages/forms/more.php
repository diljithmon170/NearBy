            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">View ProductDetails </li>
                    </ol>
                </section>
<input type="hidden" name="Date" readonly = "readonly"  value="<?php echo date('d/m/y');?>"/>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">View ProductDetails</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
          ...
          $con = new mysqli("localhost", "root", "", "ecommercedb");
            ...
            $sql = "select * from prod_details where pid='$pid'";
...
echo"<td width='100'>".$row["rate"]."</td>";
			...
			//echo'<td>  <button type="button" class="btn btn-default btn-danger"><i class="glyphicon glyphicon-trash" value="Delete"  onClick="del(' . $row["id"] . ')">Delete</i></button>';
				}echo"</tr>";
			?>
