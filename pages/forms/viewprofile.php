            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Seller Profile Details </li>
                    </ol>
                </section>
	...
	{      
	  $sid=$row["sid"];
			...
			//echo"<td width='100'>".$row["password"]."</td>";
			 echo'<td>  <button type="button" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-edit" value="edit"  onClick="upd(' . $row["sid"] . ')">Edit</i></button>';
...
function upd(uid) {
                ...
                if (ri == true) {
                    window.location.href = "edituserprofile.php?uid=" + uid;
                }
            }
			</script>