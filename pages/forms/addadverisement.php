...
<!--                            <li>
      ...
      <?php include('adminside.php')?>
           ...
           <div class="content-wrapper">
		   			  ...
		   			  <div class="form-group">
		                     <label for="exampleInputPassword1">Advertisement</label>
		                     <textarea name="adv" class="form-control" id="exampleInputPassword1" placeholder="Type Your Advertisement" required></textarea>
...
if(isset($_POST["submit"]))
{
	...
	$sql="insert into advertisement(advertisement)values('$adv')";
   ...
   window.location.href='viewadverisement.php';
    </script>";
