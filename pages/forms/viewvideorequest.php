                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">View Request Details</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">                                    
...
//$qty=$row["qty"];?>
            ...
            <td><?php echo $row['rid'] ?></td>
						                 ...
						                 <td><a href="javaScript:{openChat('<?php echo $row['link'] ?>');}">OpenChat</a>&nbsp;<a href="javaScript:{closeChat('<?php echo $row['link'] ?>','<?php echo $row['rid'] ?>');}">CloseChat</a></td>
						                                                                        <?php } else{?>
						                                                                        <td>Closed</td>
						                                                                        <?php } ?>
...
function closeChat(url,chatrequest)
	...
	// window.open(url);
	 ...
	 document.getElementById("form").action="closevideochat.php<?php echo '?rid='.$rid; ?>"
	 document.getElementById("form").submit();
	 }
	...
	// document.getElementById("vcupdate").submit();
											...
											<input type="hidden" name="r" id="rid" value=<?php echo $rid ?>>
